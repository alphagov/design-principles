...
use Rack::Rewrite do
  r301 '/service-manual/about.html', '/service-manual/start'
  ...
  r301 '/service-manual/measurement/performance-framework.html', '/service-manual/measurement/other-kpis'
  r301 '/service-manual/measurement/performance-framework', '/service-manual/measurement/other-kpis'
